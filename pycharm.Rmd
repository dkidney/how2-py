...
Add an 80 character visual guideline

`Preferences > Editor > Code Style > General > Visual guides:` 80 `columns`
...
`Preferences > Tools > Python Integrated Tools >  Docstrings > File and Code Templates`

### misc

Don't open previous projects on startup (otherwise it opens all projects that were open when last closed)
