...
If you have set up pipenv then you should see the name of the environment in bracket to the left of the terminal promt. If not, just launch the pipenv shell.
