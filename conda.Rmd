...
conda search python | grep 'pkgs/main' | tail -1 | grep -Eo "\d+\.\d+\.\d+"

# latest available python package versions
conda search pandas | grep 'pkgs/main' | tail -1 | grep -Eo "\d+\.\d+\.\d+"
conda search scikit-learn | grep 'pkgs/main' | tail -1 | grep -Eo "\d+\.\d+\.\d+"
```
